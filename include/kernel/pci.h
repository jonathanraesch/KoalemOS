...
uint8_t pci_config_read16(pci_function_addr fun_addr, uint16_t offset);
...
uint32_t pci_config_read64(pci_function_addr fun_addr, uint16_t offset);

void pci_config_write8(pci_function_addr fun_addr, uint16_t offset, uint16_t val);
